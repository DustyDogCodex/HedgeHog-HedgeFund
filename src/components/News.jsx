...
function News(){
    return (
        <section 
            className="p-5" 
            style={{margin:'50px 50px 200px 50px'}}
        >
            <h2 
            ...
            <Container className="d-flex flex-column align-items-center justify-content-between">
                ...
                >
                    <Col>
                        <Card className="bg-dark text-white mt-5 mb-5">                            
                            <Card.Img 
                                src={handshake}
                                alt="presidents shaking hands" 
                            />
                            <Card.ImgOverlay>
                                <Container 
                                    className="bg-light text-dark p-2" 
                                    style={{position:'relative', top:'140px', border:'1px solid black'}}
                                >
                ...
                <Button 
                    ...
                    style={{marginTop:'120px', alignItems:'center', width:'250px'}}
                >
                    Browse More HHF News
                </Button>
            </Container>
        </section>
    )
